import svgPaths from "./svg-xf70tbd79z";
...
function Group1() {
  return (
    <div className="absolute contents font-['Clash_Grotesk:Regular',_sans-serif] leading-[normal] left-[calc(25%+135px)] not-italic text-[18px] text-nowrap text-white top-[54px] whitespace-pre">
      <p className="absolute left-[calc(37.5%+89px)] top-[54px]">Services</p>
      <p className="absolute left-[calc(25%+135px)] top-[54px]">Smart Contracts</p>
      <p className="absolute left-[calc(37.5%+196px)] top-[54px]">Solutions</p>
      <p className="absolute left-[calc(50%+91px)] top-[54px]">Roadmap</p>
      <p className="absolute left-[calc(62.5%-11px)] top-[54px]">Whitepaper</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute bg-gradient-to-b box-border content-stretch flex from-[#497cff] gap-[10px] h-[70px] items-center justify-center left-[calc(25%+247px)] px-[32px] py-[22px] rounded-[8px] to-[#001664] top-[604px]">
      <p className="font-['Space_Grotesk:Regular',_sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-center text-nowrap text-white whitespace-pre">Get started</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="absolute bg-gradient-to-b box-border content-stretch flex from-[#d1d3e2] gap-[10px] h-[70px] items-center justify-center left-[calc(50%+3px)] px-[32px] py-[22px] rounded-[8px] to-[#75629d] top-[604px]">
      <p className="font-['Space_Grotesk:Regular',_sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-black text-center text-nowrap whitespace-pre">Ecosystems</p>
    </div>
  );
}
...
function Cta() {
  return (
    <div className="absolute contents left-[calc(25%+247px)] top-[604px]" data-name="CTA">
      <Frame2 />
      <Frame3 />
    </div>
  );
...
function MdiDiscord() {
  return (
    <div className="absolute left-[calc(87.5%-72px)] size-[20px] top-[55px]" data-name="mdi:discord">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="mdi:discord">
          <path d={svgPaths.p39373a00} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function MdiGithub() {
  return (
    <div className="absolute left-[calc(87.5%-108px)] size-[20px] top-[55px]" data-name="mdi:github">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="mdi:github">
          <path d={svgPaths.p24d9970} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function MdiTwitter() {
  return (
    <div className="absolute left-[87.5%] size-[20px] top-[55px]" data-name="mdi:twitter">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="mdi:twitter">
          <path d={svgPaths.p36d28980} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function MdiReddit() {
  return (
    <div className="absolute left-[calc(87.5%-36px)] size-[20px] top-[56px]" data-name="mdi:reddit">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="mdi:reddit">
          <path d={svgPaths.p3bd3ea80} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents left-[calc(87.5%-108px)] top-[55px]">
      <MdiDiscord />
      <MdiGithub />
      <MdiTwitter />
      <MdiReddit />
...
export default function SerendaleAiAlternate() {
  return (
    <div className="bg-black relative size-full" data-name="Serendale.ai Alternate">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.258819043636322)+(var(--transform-inner-height)*0.9659258127212524)))] items-center justify-center left-[-269px] top-[-41px] w-[calc(1px*((var(--transform-inner-height)*0.258819043636322)+(var(--transform-inner-width)*0.9659258127212524)))]" style={{ "--transform-inner-width": "2259.71875", "--transform-inner-height": "1396.125" } as React.CSSProperties}>
        <div className="flex-none rotate-[15deg]">
          <LooperBg />
        </div>
      </div>
      <p className="absolute font-['Chillax:Medium',_sans-serif] leading-[normal] left-[196px] not-italic text-[24px] text-nowrap text-white top-[48px] whitespace-pre">Serendale</p>
      <p className="absolute bg-clip-text font-['Clash_Grotesk:Medium',_sans-serif] leading-[normal] left-[calc(25%+97px)] not-italic text-[80px] text-nowrap top-[263px] tracking-[1.6px] whitespace-pre" style={{ WebkitTextFillColor: "transparent" }}>
        A Fast Blockchain.
      </p>
      <p className="absolute font-['Clash_Grotesk:Medium',_sans-serif] leading-[normal] left-[calc(25%+223px)] not-italic text-[80px] text-nowrap text-white top-[357px] tracking-[1.6px] whitespace-pre">Scalable AI.</p>
      <Group1 />
      <p className="absolute font-['Cabinet_Grotesk:Regular',_sans-serif] leading-[33px] left-[calc(12.5%+647.5px)] not-italic text-[20px] text-center text-white top-[473px] tracking-[0.72px] translate-x-[-50%] w-[723px]">Our technology performing fast blockchain (120K TPS) and it has guaranteed AI-based data security. Proof of Stake, its consensus algorithm enables unlimited speeds.</p>
      <Cta />
      <Group2 />
    </div>
  );
